...
tích bố cục tài liệu như DocLayNet và PubTables-1M cũng cho thấy xử lý bố cục và
...
\hline
\textbf{Hướng tiếp cận} & \textbf{Điểm mạnh} & \textbf{Hạn chế trong bài toán hỏi đáp trên PDF} & \textbf{Nguồn} \\
\hline
...
Hệ thống trích xuất văn bản, bảng và siêu dữ liệu nguồn như tài liệu, trang, vùng
nội dung và loại khối nội dung. \\
\hline
...
Hệ thống hỗ trợ chạy tập đánh giá để đánh giá tiếp nhận và trích xuất tài liệu, trích xuất bảng, truy xuất,
...
\hline
NFR-03 & Tính mô-đun &
Các tầng tiếp nhận và trích xuất tài liệu, chia đoạn, truy xuất và hỏi đáp cần được tách riêng để dễ kiểm thử,
...
Hệ thống cần cho phép thêm tập đánh giá hoặc cấu hình mới để phục vụ so sánh và
phân tích lỗi. \\
\hline
\end{tabularx}
\end{table}
...
bảng để đánh giá giới hạn của quy trình xử lý, nhưng chưa đặt mục tiêu xử lý hoàn chỉnh
mọi dạng PDF.
...
diện vùng bảng, giữ thứ tự đọc và bảo toàn siêu dữ liệu nguồn. Ở tầng truy xuất, hệ
...
Các định nghĩa độ đo và công thức được trình bày tập trung tại Chương 3 và quy
...
Tầng tiếp nhận và trích xuất tài liệu PDF &
Mục 6.2.1 và Mục 6.2.2\\
\hline
FR-03 & Định tuyến theo vùng nội dung &
Định tuyến theo vùng nội dung, siêu dữ liệu vùng &
Mục 6.2.1 và Mục 6.4.1\\
\hline
FR-04 & Chia đoạn và lập chỉ mục &
Chia đoạn văn bản, chia đoạn có nhận thức bảng, lập chỉ mục &
Mục 6.2.3 và Mục 6.4.5 \\
\hline
FR-05 & Truy xuất bằng chứng &
BM25, truy xuất ngữ nghĩa, truy xuất kết hợp, sắp xếp lại &
Mục 6.2.4 và Mục 6.4.2 \\
\hline
FR-06, FR-07 & Hỏi đáp có căn cứ và dẫn chứng &
Bộ kiểm tra bằng chứng, bộ sinh câu trả lời, dẫn chứng nguồn &
Mục 6.2.5 và Mục 6.4.3 \\
\hline
FR-08, NFR-05 & Đánh giá thực nghiệm &
Tập lệnh đánh giá, cấu hình thí nghiệm loại bỏ thành phần &
Chương 6, đặc biệt Mục 6.2, Mục 6.3 và Mục 6.4 \\
\hline
NFR-01, NFR-02 & Khả năng kiểm chứng và tính có căn cứ &
Siêu dữ liệu nguồn, vị trí dẫn chứng nguồn, bằng chứng ở mức ô &
Mục 6.2.5, Mục 6.4.3 và Mục 6.4.5 \\
\hline
NFR-03, NFR-04 & Tính mô-đun và hiệu năng &
Tổ chức quy trình xử lý theo tầng, lưu chỉ mục tách biệt &
Mục 6.1.1, Mục 6.1.3 và Mục 6.2 \\
\hline
\end{tabularx}
\end{table}
