...
\emph{Transactions on Machine Learning Research}, 2022. [Trực tuyến]. Có tại:
...
\emph{arXiv preprint arXiv:1901.04085}, 2019. [Trực tuyến]. Có tại:
...
Representations}, 2024. [Trực tuyến]. Có tại:
...
D. Chen, W. Dai, H. S. Chan, A. Madotto, and P. Fung,
``Survey of hallucination in natural language generation,''
\emph{ACM Computing Surveys}, vol. 55, no. 12, pp. 1--38, 2023,
doi: 10.1145/3571730.

\bibitem{fabbri2021qafacteval}
A. R. Fabbri, C.-S. Wu, W. Liu, and C. Xiong,
``QAFactEval: Improved QA-based factual consistency evaluation for
summarization,''
in \emph{Proceedings of the 2022 Conference of the North American Chapter of
the Association for Computational Linguistics: Human Language Technologies},
pp. 2587--2601, 2022,
...
in \emph{Proceedings of the 18th Conference of the European Chapter of the
...
Z. Shen, R. Zhang, M. Dell, B. C. G. Lee, J. Carlson, and W. Li,
``LayoutParser: A unified toolkit for deep learning based document image
analysis,''
in \emph{Document Analysis and Recognition -- ICDAR 2021},
pp. 131--146, 2021,
...
\bibitem{zanibbi2004survey}
R. Zanibbi, D. Blostein, and J. R. Cordy,
``A survey of table recognition: Models, observations, transformations, and
inferences,''
...
\emph{arXiv preprint arXiv:2009.09941}, 2020. [Trực tuyến]. Có tại:
...
in \emph{2019 International Conference on Document Analysis and Recognition
Workshops (ICDARW)}, vol. 2, pp. 1--6, 2019,
...
Đại học Bách khoa Hà Nội},
ngày 28 tháng 5 năm 2025. [Trực tuyến]. Có tại:
...
\bibitem{pymupdf2026}
Artifex Software,
\emph{PyMuPDF Documentation, version 1.24.0}.
[Trực tuyến]. Có tại: \url{https://pymupdf.readthedocs.io/}.
