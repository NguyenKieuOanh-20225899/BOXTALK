...
từng tầng: tài liệu PDF trước hết phải được chuyển thành khối nội dung, bảng, ô và
...
Mặc dù đạt được các kết quả tích cực trên tập đánh giá chính, đồ án vẫn còn một số
hạn chế rõ ràng.

Khả năng xử lý PDF quét thực tế chưa được đánh giá đầy đủ. Kết quả OCR
trên tập quét tổng hợp cao, nhưng chênh lệch với các tập dữ liệu nhiễu hơn cho thấy
hệ thống vẫn nhạy với chất lượng ảnh, bố cục phức tạp và sai lệch hộp từ. Vì vậy,
đồ án chưa thể khẳng định hiệu quả tương đương trên các tài liệu quét tiếng Việt
thực tế.
...
Một giới hạn khác là các độ đo về bảo đảm căn cứ và sinh thông tin không được nguồn hỗ trợ trong đồ án phụ thuộc vào quy
...
Hướng thứ nhất là mở rộng đánh giá và cải thiện luồng trích xuất cho PDF quét tiếng Việt
...
đồ thị để tái dựng quan hệ hàng, cột và ô gộp một cách nhất quán hơn.
...
trích xuất PDF. Việc tổ chức lại tài liệu thành các khối nội dung, bảng, ô và siêu dữ liệu nguồn
...
đồ án cũng cho thấy những giới hạn còn lại ở xử lý tài liệu quét, tái dựng bảng phức tạp và
